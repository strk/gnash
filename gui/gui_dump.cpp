...
#ifdef GUI_DUMP
std::auto_ptr<Gui> createDumpGui(unsigned long windowid, float scale, bool do_loop, unsigned int bit_depth)
{
	return std::auto_ptr<Gui>(new DumpGui(windowid, scale, do_loop, bit_depth));
}
#else // ! GUI_DUMP
