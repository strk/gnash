// DisplacementMapFilterMode_as3.h:  ActionScript 3 "DisplacementMapFilterMode" class, for Gnash.
//
...
class DisplacementMapFilterMode_as3: public as_object
{

public:

    DisplacementMapFilterMode_as3()
        :
        as_object(getDisplacementMapFilterModeInterface())
    {}
