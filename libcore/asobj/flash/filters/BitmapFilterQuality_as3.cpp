// BitmapFilterQuality_as3.cpp:  ActionScript "BitmapFilterQuality" class, for Gnash.
//
...
#include "filters/BitmapFilterQuality_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new BitmapFilterQuality_as3;
