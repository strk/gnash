// BitmapFilterType_as3.cpp:  ActionScript "BitmapFilterType" class, for Gnash.
//
...
#include "filters/BitmapFilterType_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new BitmapFilterType_as3;
