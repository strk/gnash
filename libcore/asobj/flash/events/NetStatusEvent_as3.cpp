// NetStatusEvent_as3.cpp:  ActionScript "NetStatusEvent" class, for Gnash.
//
...
#include "events/NetStatusEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<NetStatusEvent_as3> ptr =
        ensureType<NetStatusEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new NetStatusEvent_as3;
