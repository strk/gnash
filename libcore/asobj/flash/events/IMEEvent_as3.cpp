// IMEEvent_as3.cpp:  ActionScript "IMEEvent" class, for Gnash.
//
...
{
    boost::intrusive_ptr<IMEEvent_as3> ptr =
        ensureType<IMEEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new IMEEvent_as3;
