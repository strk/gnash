// FocusEvent_as3.cpp:  ActionScript "FocusEvent" class, for Gnash.
//
...
#include "events/FocusEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<FocusEvent_as3> ptr =
        ensureType<FocusEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new FocusEvent_as3;
