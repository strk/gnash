// SecurityErrorEvent_as3.h:  ActionScript 3 "SecurityErrorEvent" class, for Gnash.
//
...
class SecurityErrorEvent_as3: public as_object
{

public:

    SecurityErrorEvent_as3()
        :
        as_object(getSecurityErrorEventInterface())
    {}
...
// GNASH_ASOBJ3_SECURITYERROREVENT_H
#endif
