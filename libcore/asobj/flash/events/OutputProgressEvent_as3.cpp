// OutputProgressEvent_as3.cpp:  ActionScript "OutputProgressEvent" class, for Gnash.
//
...
#include "events/OutputProgressEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new OutputProgressEvent_as3;
