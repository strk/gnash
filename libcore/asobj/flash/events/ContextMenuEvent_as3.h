// ContextMenuEvent_as3.h:  ActionScript 3 "ContextMenuEvent" class, for Gnash.
//
...
class ContextMenuEvent_as3: public as_object
{

public:

    ContextMenuEvent_as3()
        :
        as_object(getContextMenuEventInterface())
    {}
...
// GNASH_ASOBJ3_CONTEXTMENUEVENT_H
#endif
