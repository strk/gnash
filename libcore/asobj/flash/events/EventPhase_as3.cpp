// EventPhase_as3.cpp:  ActionScript "EventPhase" class, for Gnash.
//
...
#include "events/EventPhase_as3.h"
#include "log.h"
#include "fn_call.h"
...
void eventphase_class_init(as_object& global)
{
    ...
    global.init_member("EventPhase", cl.get());
}
...
{
    boost::intrusive_ptr<as_object> obj = new EventPhase_as3;
