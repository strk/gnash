// AsyncErrorEvent_as3.cpp:  ActionScript "AsyncErrorEvent" class, for Gnash.
//
...
#include "events/AsyncErrorEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<AsyncErrorEvent_as3> ptr =
        ensureType<AsyncErrorEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new AsyncErrorEvent_as3;
