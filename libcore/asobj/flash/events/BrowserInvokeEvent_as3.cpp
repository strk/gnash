// BrowserInvokeEvent_as3.cpp:  ActionScript "BrowserInvokeEvent" class, for Gnash.
//
...
#include "events/BrowserInvokeEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new BrowserInvokeEvent_as3;
