// DRMStatusEvent_as3.cpp:  ActionScript "DRMStatusEvent" class, for Gnash.
//
...
#include "events/DRMStatusEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new DRMStatusEvent_as3;
