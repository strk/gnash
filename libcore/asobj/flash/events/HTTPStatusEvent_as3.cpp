// HTTPStatusEvent_as3.cpp:  ActionScript "HTTPStatusEvent" class, for Gnash.
//
...
#include "events/HTTPStatusEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<HTTPStatusEvent_as3> ptr =
        ensureType<HTTPStatusEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new HTTPStatusEvent_as3;
