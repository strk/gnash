// ErrorEvent_as3.cpp:  ActionScript "ErrorEvent" class, for Gnash.
//
...
#include "events/ErrorEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<ErrorEvent_as3> ptr =
        ensureType<ErrorEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ErrorEvent_as3;
