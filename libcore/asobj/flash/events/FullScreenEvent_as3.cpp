// FullScreenEvent_as3.cpp:  ActionScript "FullScreenEvent" class, for Gnash.
//
...
#include "events/FullScreenEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<FullScreenEvent_as3> ptr =
        ensureType<FullScreenEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new FullScreenEvent_as3;
