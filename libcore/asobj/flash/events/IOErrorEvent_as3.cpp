// IOErrorEvent_as3.cpp:  ActionScript "IOErrorEvent" class, for Gnash.
//
...
#include "events/IOErrorEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    o.init_member("toString", new builtin_function(ioerrorevent_toString));
    o.init_member("IO_ERROR", new builtin_function(ioerrorevent_IO_ERROR));
}
...
{
    boost::intrusive_ptr<IOErrorEvent_as3> ptr =
        ensureType<IOErrorEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new IOErrorEvent_as3;
