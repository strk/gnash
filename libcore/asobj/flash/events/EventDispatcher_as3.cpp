// EventDispatcher_as3.cpp:  ActionScript "EventDispatcher" class, for Gnash.
//
...
#include "events/EventDispatcher_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<EventDispatcher_as3> ptr =
        ensureType<EventDispatcher_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new EventDispatcher_as3;
