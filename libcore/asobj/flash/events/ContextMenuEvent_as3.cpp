// ContextMenuEvent_as3.cpp:  ActionScript "ContextMenuEvent" class, for Gnash.
//
...
#include "events/ContextMenuEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<ContextMenuEvent_as3> ptr =
        ensureType<ContextMenuEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ContextMenuEvent_as3;
