// IEventDispatcher_as3.h:  ActionScript 3 "IEventDispatcher" class, for Gnash.
//
...
class IEventDispatcher_as3: public as_object
{

public:

    IEventDispatcher_as3()
        :
        as_object(getIEventDispatcherInterface())
    {}
...
// GNASH_ASOBJ3_IEVENTDISPATCHER_H
#endif
