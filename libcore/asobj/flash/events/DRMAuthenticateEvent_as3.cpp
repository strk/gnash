// DRMAuthenticateEvent_as3.cpp:  ActionScript "DRMAuthenticateEvent" class, for Gnash.
//
...
#include "events/DRMAuthenticateEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new DRMAuthenticateEvent_as3;
