// MouseEvent_as3.cpp:  ActionScript "MouseEvent" class, for Gnash.
//
...
#include "events/MouseEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<MouseEvent_as3> ptr =
        ensureType<MouseEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new MouseEvent_as3;
