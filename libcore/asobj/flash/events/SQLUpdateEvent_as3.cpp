// SQLUpdateEvent_as3.cpp:  ActionScript "SQLUpdateEvent" class, for Gnash.
//
...
#include "events/SQLUpdateEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLUpdateEvent_as3;
