// KeyboardEvent_as3.cpp:  ActionScript "KeyboardEvent" class, for Gnash.
//
...
#include "events/KeyboardEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<KeyboardEvent_as3> ptr =
        ensureType<KeyboardEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new KeyboardEvent_as3;
