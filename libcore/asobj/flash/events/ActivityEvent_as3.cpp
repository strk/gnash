// ActivityEvent_as3.cpp:  ActionScript "ActivityEvent" class, for Gnash.
//
...
#include "events/ActivityEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<ActivityEvent_as3> ptr =
        ensureType<ActivityEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ActivityEvent_as3;
