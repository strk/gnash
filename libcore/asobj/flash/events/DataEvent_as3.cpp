// DataEvent_as3.cpp:  ActionScript "DataEvent" class, for Gnash.
//
...
#include "events/DataEvent_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<DataEvent_as3> ptr =
        ensureType<DataEvent_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new DataEvent_as3;
