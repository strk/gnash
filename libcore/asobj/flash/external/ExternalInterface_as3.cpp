// ExternalInterface_as3.cpp:  ActionScript "ExternalInterface" class, for Gnash.
//
...
#include "external/ExternalInterface_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<ExternalInterface_as3> ptr =
        ensureType<ExternalInterface_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ExternalInterface_as3;
