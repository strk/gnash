// HTMLHistoryItem_as.cpp:  ActionScript "HTMLHistoryItem" class, for Gnash.
//
...
#include "html/HTMLHistoryItem_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new HTMLHistoryItem_as;
