// HTMLWindowCreateOptions_as3.cpp:  ActionScript "HTMLWindowCreateOptions" class, for Gnash.
//
...
#include "html/HTMLWindowCreateOptions_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new HTMLWindowCreateOptions_as3;
