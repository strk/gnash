// SoundTransform_as3.cpp:  ActionScript "SoundTransform" class, for Gnash.
//
...
#include "media/SoundTransform_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SoundTransform_as3;
