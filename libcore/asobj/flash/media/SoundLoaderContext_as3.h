// SoundLoaderContext_as3.h:  ActionScript 3 "SoundLoaderContext" class, for Gnash.
//
...
class SoundLoaderContext_as3: public as_object
{

public:

    SoundLoaderContext_as3()
        :
        as_object(getSoundLoaderContextInterface())
    {}
...
// GNASH_ASOBJ3_SOUNDLOADERCONTEXT_H
#endif
