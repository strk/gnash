// SoundChannel_as3.cpp:  ActionScript "SoundChannel" class, for Gnash.
//
...
#include "media/SoundChannel_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<SoundChannel_as3> ptr =
        ensureType<SoundChannel_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new SoundChannel_as3;
