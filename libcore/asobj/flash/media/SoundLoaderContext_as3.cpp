// SoundLoaderContext_as3.cpp:  ActionScript "SoundLoaderContext" class, for Gnash.
//
...
#include "media/SoundLoaderContext_as3.h"
#include "log.h"
#include "fn_call.h"
...
void soundloadercontext_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&soundloadercontext_ctor, getSoundLoaderContextInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new SoundLoaderContext_as3;
