// Camera_as3.cpp:  ActionScript "Camera" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Camera_as3> ptr =
        ensureType<Camera_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Camera_as3;
