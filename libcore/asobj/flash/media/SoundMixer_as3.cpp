// SoundMixer_as3.cpp:  ActionScript "SoundMixer" class, for Gnash.
//
...
#include "media/SoundMixer_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<SoundMixer_as3> ptr =
        ensureType<SoundMixer_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new SoundMixer_as3;
