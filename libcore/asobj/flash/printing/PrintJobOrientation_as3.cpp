// PrintJobOrientation_as3.cpp:  ActionScript "PrintJobOrientation" class, for Gnash.
//
...
#include "printing/PrintJobOrientation_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new PrintJobOrientation_as3;
