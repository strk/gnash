// PrintJob_as3.cpp:  ActionScript "PrintJob" class, for Gnash.
//
...
#include "printing/PrintJob_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<PrintJob_as3> ptr =
        ensureType<PrintJob_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new PrintJob_as3;
