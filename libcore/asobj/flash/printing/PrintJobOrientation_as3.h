// PrintJobOrientation_as3.h:  ActionScript 3 "PrintJobOrientation" class, for Gnash.
//
...
class PrintJobOrientation_as3: public as_object
{

public:

    PrintJobOrientation_as3()
        :
        as_object(getPrintJobOrientationInterface())
    {}
...
// GNASH_ASOBJ3_PRINTJOBORIENTATION_H
#endif
