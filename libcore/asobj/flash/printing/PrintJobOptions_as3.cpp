// PrintJobOptions_as3.cpp:  ActionScript "PrintJobOptions" class, for Gnash.
//
...
#include "printing/PrintJobOptions_as3.h"
#include "log.h"
#include "fn_call.h"
...
void printjoboptions_class_init(as_object& global)
{
    ...
    global.init_member("PrintJobOptions", cl.get());
}
...
{
    boost::intrusive_ptr<as_object> obj = new PrintJobOptions_as3;
