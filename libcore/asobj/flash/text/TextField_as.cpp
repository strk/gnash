...
TextField_as::TextField_as(DisplayObject* parent, const SWF::DefineEditTextTag& def,
        int id)
    :
...
{
    boost::intrusive_ptr<TextField_as> ptr = ensureType<TextField_as>(fn.this_ptr);
...
{
    boost::intrusive_ptr<TextField_as> text = ensureType<TextField_as>(fn.this_ptr);
