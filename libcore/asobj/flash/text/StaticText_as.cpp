// StaticText_as.cpp:  ActionScript "StaticText" class, for Gnash.
//
...
void statictext_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&statictext_ctor, getStaticTextInterface());
        attachStaticTextStaticInterface(*cl);
    }

    // Register _global.StaticText
    global.init_member("StaticText", cl.get());
}
