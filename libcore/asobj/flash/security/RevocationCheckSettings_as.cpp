// RevocationCheckSettings_as.cpp:  ActionScript "RevocationCheckSettings" class, for Gnash.
//
...
#include "security/RevocationCheckSettings_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new RevocationCheckSettings_as;
