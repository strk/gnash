// SignatureStatus_as3.cpp:  ActionScript "SignatureStatus" class, for Gnash.
//
...
#include "security/SignatureStatus_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SignatureStatus_as3;
