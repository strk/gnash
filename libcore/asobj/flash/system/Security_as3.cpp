// Security_as3.cpp:  ActionScript "Security" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Security_as3> ptr =
        ensureType<Security_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Security_as3;
