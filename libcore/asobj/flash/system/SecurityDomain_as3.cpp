// SecurityDomain_as3.cpp:  ActionScript "SecurityDomain" class, for Gnash.
//
...
#include "system/SecurityDomain_as3.h"
#include "log.h"
#include "fn_call.h"
...
void securitydomain_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&securitydomain_ctor, getSecurityDomainInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new SecurityDomain_as3;
