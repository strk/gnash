// IMEConversionMode_as3.cpp:  ActionScript "IMEConversionMode" class, for Gnash.
//
...
#include "system/IMEConversionMode_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new IMEConversionMode_as3;
