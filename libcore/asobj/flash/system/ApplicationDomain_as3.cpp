// ApplicationDomain_as3.cpp:  ActionScript "ApplicationDomain" class, for Gnash.
//
...
#include "system/ApplicationDomain_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<ApplicationDomain_as3> ptr =
        ensureType<ApplicationDomain_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ApplicationDomain_as3;
