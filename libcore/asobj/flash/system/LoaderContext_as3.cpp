// LoaderContext_as3.cpp:  ActionScript "LoaderContext" class, for Gnash.
//
...
#include "system/LoaderContext_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new LoaderContext_as3;
