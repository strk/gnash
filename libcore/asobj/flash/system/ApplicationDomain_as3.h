// ApplicationDomain_as3.h:  ActionScript 3 "ApplicationDomain" class, for Gnash.
//
...
class ApplicationDomain_as3: public as_object
{

public:

    ApplicationDomain_as3()
        :
        as_object(getApplicationDomainInterface())
    {}
...
// GNASH_ASOBJ3_APPLICATIONDOMAIN_H
#endif
