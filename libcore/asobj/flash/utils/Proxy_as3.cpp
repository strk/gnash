// Proxy_as3.cpp:  ActionScript "Proxy" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Proxy_as3> ptr =
        ensureType<Proxy_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Proxy_as3;
