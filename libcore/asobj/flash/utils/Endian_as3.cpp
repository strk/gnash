// Endian_as3.cpp:  ActionScript "Endian" class, for Gnash.
//
...
void endian_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&endian_ctor, getEndianInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new Endian_as3;
