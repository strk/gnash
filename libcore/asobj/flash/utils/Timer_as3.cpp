// Timer_as3.cpp:  ActionScript "Timer" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Timer_as3> ptr =
        ensureType<Timer_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Timer_as3;
