// IDataInput_as3.cpp:  ActionScript "IDataInput" class, for Gnash.
//
...
#include "utils/IDataInput_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<IDataInput_as3> ptr =
        ensureType<IDataInput_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new IDataInput_as3;
