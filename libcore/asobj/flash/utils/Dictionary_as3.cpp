// Dictionary_as3.cpp:  ActionScript "Dictionary" class, for Gnash.
//
...
#include "utils/Dictionary_as3.h"
#include "log.h"
#include "fn_call.h"
...
void dictionary_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&dictionary_ctor, getDictionaryInterface());
        attachDictionaryStaticInterface(*cl);
    }

    // Register _global.Dictionary
    global.init_member("Dictionary", cl.get());
}
...
{
    boost::intrusive_ptr<as_object> obj = new Dictionary_as3;
