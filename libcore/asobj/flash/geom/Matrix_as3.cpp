// Matrix_as3.cpp:  ActionScript "Matrix" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Matrix_as3> ptr =
        ensureType<Matrix_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Matrix_as3;
