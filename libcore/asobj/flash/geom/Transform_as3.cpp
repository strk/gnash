// Transform_as3.cpp:  ActionScript "Transform" class, for Gnash.
//
...
namespace {
    ...
    void attachTransformStaticInterface(as_object& o);
...
void transform_class_init(as_object& global)
{
    ...
    if (!cl) {
        ...
        attachTransformStaticInterface(*cl);
    }
...
void
attachTransformStaticInterface(as_object& o)
{
...
{
    boost::intrusive_ptr<as_object> obj = new Transform_as3;
