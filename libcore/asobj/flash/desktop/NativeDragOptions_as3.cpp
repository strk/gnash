// NativeDragOptions_as3.cpp:  ActionScript "NativeDragOptions" class, for Gnash.
//
...
#include "desktop/NativeDragOptions_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new NativeDragOptions_as3;
