// ClipboardTransferMode_as3.h:  ActionScript 3 "ClipboardTransferMode" class, for Gnash.
//
...
class ClipboardTransferMode_as3: public as_object
{

public:

    ClipboardTransferMode_as3()
        :
        as_object(getClipboardTransferModeInterface())
    {}
