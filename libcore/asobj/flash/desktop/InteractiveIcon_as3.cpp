// InteractiveIcon_as3.cpp:  ActionScript "InteractiveIcon" class, for Gnash.
//
...
#include "desktop/InteractiveIcon_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new InteractiveIcon_as3;
