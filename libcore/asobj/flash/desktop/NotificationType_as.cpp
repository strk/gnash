// NotificationType_as.cpp:  ActionScript "NotificationType" class, for Gnash.
//
...
#include "desktop/NotificationType_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new NotificationType_as;
