// ClipboardFormats_as3.cpp:  ActionScript "ClipboardFormats" class, for Gnash.
//
...
#include "desktop/ClipboardFormats_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new ClipboardFormats_as3;
