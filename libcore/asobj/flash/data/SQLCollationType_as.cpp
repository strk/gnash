// SQLCollationType_as.cpp:  ActionScript "SQLCollationType" class, for Gnash.
//
...
#include "data/SQLCollationType_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLCollationType_as;
