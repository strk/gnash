// SQLViewSchema_as3.cpp:  ActionScript "SQLViewSchema" class, for Gnash.
//
...
#include "data/SQLViewSchema_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLViewSchema_as3;
