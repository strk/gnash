// SQLTableSchema_as.cpp:  ActionScript "SQLTableSchema" class, for Gnash.
//
...
#include "data/SQLTableSchema_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLTableSchema_as;
