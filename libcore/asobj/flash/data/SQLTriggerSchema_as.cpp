// SQLTriggerSchema_as.cpp:  ActionScript "SQLTriggerSchema" class, for Gnash.
//
...
#include "data/SQLTriggerSchema_as.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLTriggerSchema_as;
