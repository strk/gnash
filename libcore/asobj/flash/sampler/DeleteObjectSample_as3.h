// DeleteObjectSample_as3.h:  ActionScript 3 "DeleteObjectSample" class, for Gnash.
//
...
class DeleteObjectSample_as3: public as_object
{

public:

    DeleteObjectSample_as3()
        :
        as_object(getDeleteObjectSampleInterface())
    {}
...
// GNASH_ASOBJ3_DELETEOBJECTSAMPLE_H
#endif
