// Sample_as3.cpp:  ActionScript "Sample" class, for Gnash.
//
...
void sample_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&sample_ctor, getSampleInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new Sample_as3;
