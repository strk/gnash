// DeleteObjectSample_as3.cpp:  ActionScript "DeleteObjectSample" class, for Gnash.
//
...
#include "sampler/DeleteObjectSample_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new DeleteObjectSample_as3;
