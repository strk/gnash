// NewObjectSample_as3.cpp:  ActionScript "NewObjectSample" class, for Gnash.
//
...
#include "sampler/NewObjectSample_as3.h"
#include "log.h"
#include "fn_call.h"
...
void newobjectsample_class_init(as_object& global)
{
    ...
    global.init_member("NewObjectSample", cl.get());
}
...
{
    boost::intrusive_ptr<as_object> obj = new NewObjectSample_as3;
