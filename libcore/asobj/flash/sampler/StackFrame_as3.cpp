// StackFrame_as3.cpp:  ActionScript "StackFrame" class, for Gnash.
//
...
#include "sampler/StackFrame_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<StackFrame_as3> ptr =
        ensureType<StackFrame_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new StackFrame_as3;
