// ContextMenuBuiltInItems_as3.cpp:  ActionScript "ContextMenuBuiltInItems" class, for Gnash.
//
...
#include "ui/ContextMenuBuiltInItems_as3.h"
#include "log.h"
#include "fn_call.h"
...
void contextmenubuiltinitems_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&contextmenubuiltinitems_ctor, getContextMenuBuiltInItemsInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new ContextMenuBuiltInItems_as3;
