// ContextMenuBuiltInItems_as3.h:  ActionScript 3 "ContextMenuBuiltInItems" class, for Gnash.
//
...
class ContextMenuBuiltInItems_as3: public as_object
{

public:

    ContextMenuBuiltInItems_as3()
        :
        as_object(getContextMenuBuiltInItemsInterface())
    {}
...
// GNASH_ASOBJ3_CONTEXTMENUBUILTINITEMS_H
#endif
