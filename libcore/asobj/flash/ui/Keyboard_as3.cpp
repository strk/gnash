// Keyboard_as3.cpp:  ActionScript "Keyboard" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Keyboard_as3> ptr =
        ensureType<Keyboard_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Keyboard_as3;
