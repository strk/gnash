// ContextMenuItem_as3.cpp:  ActionScript "ContextMenuItem" class, for Gnash.
//
...
#include "ui/ContextMenuItem_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new ContextMenuItem_as3;
