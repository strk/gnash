// ContextMenu_as3.cpp:  ActionScript "ContextMenu" class, for Gnash.
//
...
{
    boost::intrusive_ptr<ContextMenu_as3> ptr =
        ensureType<ContextMenu_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new ContextMenu_as3;
