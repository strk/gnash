// Mouse_as.cpp:  ActionScript "Mouse" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Mouse_as> ptr =
        ensureType<Mouse_as>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Mouse_as;
