// AVM1Movie_as.cpp:  ActionScript "AVM1Movie" class, for Gnash.
//
...
namespace {
    as_value avm1movie_ctor(const fn_call& fn);
    void attachAVM1MovieInterface(as_object& o);
    void attachAVM1MovieStaticInterface(as_object& o);
