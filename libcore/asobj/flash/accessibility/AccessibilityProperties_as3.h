// AccessibilityProperties_as3.h:  ActionScript 3 "AccessibilityProperties" class, for Gnash.
//
...
class AccessibilityProperties_as3: public as_object
{

public:

    AccessibilityProperties_as3()
        :
        as_object(getAccessibilityPropertiesInterface())
    {}
...
// GNASH_ASOBJ3_ACCESSIBILITYPROPERTIES_H
#endif
