// AccessibilityProperties_as3.cpp:  ActionScript "AccessibilityProperties" class, for Gnash.
//
...
#include "accessibility/AccessibilityProperties_as3.h"
#include "log.h"
#include "fn_call.h"
...
void accessibilityproperties_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&accessibilityproperties_ctor, getAccessibilityPropertiesInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new AccessibilityProperties_as3;
