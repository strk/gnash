// XMLNodeType_as3.cpp:  ActionScript "XMLNodeType" class, for Gnash.
//
...
void xmlnodetype_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&xmlnodetype_ctor, getXMLNodeTypeInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new XMLNodeType_as3;
