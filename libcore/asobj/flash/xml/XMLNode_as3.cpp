// XMLNode_as3.cpp:  ActionScript "XMLNode" class, for Gnash.
//
...
{
    boost::intrusive_ptr<XMLNode_as3> ptr =
        ensureType<XMLNode_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new XMLNode_as3;
