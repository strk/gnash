// SQLErrorOperation_as3.cpp:  ActionScript "SQLErrorOperation" class, for Gnash.
//
...
#include "errors/SQLErrorOperation_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new SQLErrorOperation_as3;
