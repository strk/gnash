// ScriptTimeoutError_as3.cpp:  ActionScript "ScriptTimeoutError" class, for Gnash.
//
...
#include "errors/ScriptTimeoutError_as3.h"
#include "log.h"
#include "fn_call.h"
...
void scripttimeouterror_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&scripttimeouterror_ctor, getScriptTimeoutErrorInterface());
        attachScriptTimeoutErrorStaticInterface(*cl);
    }

    // Register _global.ScriptTimeoutError
    global.init_member("ScriptTimeoutError", cl.get());
}
...
{
    boost::intrusive_ptr<as_object> obj = new ScriptTimeoutError_as3;
