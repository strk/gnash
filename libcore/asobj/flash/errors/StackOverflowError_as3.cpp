// StackOverflowError_as3.cpp:  ActionScript "StackOverflowError" class, for Gnash.
//
...
#include "errors/StackOverflowError_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new StackOverflowError_as3;
