// IllegalOperationError_as3.h:  ActionScript 3 "IllegalOperationError" class, for Gnash.
//
...
class IllegalOperationError_as3: public as_object
{

public:

    IllegalOperationError_as3()
        :
        as_object(getIllegalOperationErrorInterface())
    {}
...
// GNASH_ASOBJ3_ILLEGALOPERATIONERROR_H
#endif
