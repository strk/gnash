// InvalidSWFError_as3.cpp:  ActionScript "InvalidSWFError" class, for Gnash.
//
...
#include "errors/InvalidSWFError_as3.h"
#include "log.h"
#include "fn_call.h"
...
void invalidswferror_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&invalidswferror_ctor, getInvalidSWFErrorInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new InvalidSWFError_as3;
