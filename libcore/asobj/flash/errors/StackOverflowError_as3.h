// StackOverflowError_as3.h:  ActionScript 3 "StackOverflowError" class, for Gnash.
//
...
class StackOverflowError_as3: public as_object
{

public:

    StackOverflowError_as3()
        :
        as_object(getStackOverflowErrorInterface())
    {}
...
// GNASH_ASOBJ3_STACKOVERFLOWERROR_H
#endif
