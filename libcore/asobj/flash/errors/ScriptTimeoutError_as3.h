// ScriptTimeoutError_as3.h:  ActionScript 3 "ScriptTimeoutError" class, for Gnash.
//
...
class ScriptTimeoutError_as3: public as_object
{

public:

    ScriptTimeoutError_as3()
        :
        as_object(getScriptTimeoutErrorInterface())
    {}
...
// GNASH_ASOBJ3_SCRIPTTIMEOUTERROR_H
#endif
