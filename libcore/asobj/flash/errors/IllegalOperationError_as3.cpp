// IllegalOperationError_as3.cpp:  ActionScript "IllegalOperationError" class, for Gnash.
//
...
#include "errors/IllegalOperationError_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new IllegalOperationError_as3;
