// IDynamicPropertyWriter_as3.h:  ActionScript 3 "IDynamicPropertyWriter" class, for Gnash.
//
...
class IDynamicPropertyWriter_as3: public as_object
{

public:

    IDynamicPropertyWriter_as3()
        :
        as_object(getIDynamicPropertyWriterInterface())
    {}
...
// GNASH_ASOBJ3_IDYNAMICPROPERTYWRITER_H
#endif
