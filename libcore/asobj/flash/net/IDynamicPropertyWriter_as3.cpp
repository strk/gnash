// IDynamicPropertyWriter_as3.cpp:  ActionScript "IDynamicPropertyWriter" class, for Gnash.
//
...
#include "net/IDynamicPropertyWriter_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new IDynamicPropertyWriter_as3;
