// IDynamicPropertyOutput_as3.h:  ActionScript 3 "IDynamicPropertyOutput" class, for Gnash.
//
...
class IDynamicPropertyOutput_as3: public as_object
{

public:

    IDynamicPropertyOutput_as3()
        :
        as_object(getIDynamicPropertyOutputInterface())
    {}
...
// GNASH_ASOBJ3_IDYNAMICPROPERTYOUTPUT_H
#endif
