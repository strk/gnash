// URLLoaderDataFormat_as3.cpp:  ActionScript "URLLoaderDataFormat" class, for Gnash.
//
...
#include "net/URLLoaderDataFormat_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<as_object> obj = new URLLoaderDataFormat_as3;
