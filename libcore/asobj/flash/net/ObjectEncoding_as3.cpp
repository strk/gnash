// ObjectEncoding_as3.cpp:  ActionScript "ObjectEncoding" class, for Gnash.
//
...
#include "net/ObjectEncoding_as3.h"
#include "log.h"
#include "fn_call.h"
...
void objectencoding_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&objectencoding_ctor, getObjectEncodingInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new ObjectEncoding_as3;
