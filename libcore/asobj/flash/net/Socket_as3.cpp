// Socket_as3.cpp:  ActionScript "Socket" class, for Gnash.
//
...
{
    boost::intrusive_ptr<Socket_as3> ptr =
        ensureType<Socket_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new Socket_as3;
