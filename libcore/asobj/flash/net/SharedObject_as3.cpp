// SharedObject_as3.cpp:  ActionScript "SharedObject" class, for Gnash.
//
...
#include "net/SharedObject_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<SharedObject_as3> ptr =
        ensureType<SharedObject_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new SharedObject_as3;
