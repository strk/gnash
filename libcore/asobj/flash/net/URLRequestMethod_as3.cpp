// URLRequestMethod_as3.cpp:  ActionScript "URLRequestMethod" class, for Gnash.
//
...
#include "net/URLRequestMethod_as3.h"
#include "log.h"
#include "fn_call.h"
...
void urlrequestmethod_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&urlrequestmethod_ctor, getURLRequestMethodInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new URLRequestMethod_as3;
