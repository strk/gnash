// LocalConnection_as3.cpp:  ActionScript "LocalConnection" class, for Gnash.
//
...
#include "net/LocalConnection_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<LocalConnection_as3> ptr =
        ensureType<LocalConnection_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new LocalConnection_as3;
