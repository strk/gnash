// NetStream_as3.cpp:  ActionScript "NetStream" class, for Gnash.
//
...
{
    boost::intrusive_ptr<NetStream_as3> ptr =
        ensureType<NetStream_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new NetStream_as3;
