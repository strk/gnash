// FileFilter_as3.cpp:  ActionScript "FileFilter" class, for Gnash.
//
...
void filefilter_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&filefilter_ctor, getFileFilterInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new FileFilter_as3;
