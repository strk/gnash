// URLLoader_as3.cpp:  ActionScript "URLLoader" class, for Gnash.
//
...
{
    boost::intrusive_ptr<URLLoader_as3> ptr =
        ensureType<URLLoader_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new URLLoader_as3;
