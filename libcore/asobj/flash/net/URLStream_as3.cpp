// URLStream_as3.cpp:  ActionScript "URLStream" class, for Gnash.
//
...
{
    boost::intrusive_ptr<URLStream_as3> ptr =
        ensureType<URLStream_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new URLStream_as3;
