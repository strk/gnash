// URLRequestHeader_as3.cpp:  ActionScript "URLRequestHeader" class, for Gnash.
//
...
#include "net/URLRequestHeader_as3.h"
#include "log.h"
#include "fn_call.h"
...
void urlrequestheader_class_init(as_object& global)
{
    ...
    if (!cl) {
        cl = new builtin_function(&urlrequestheader_ctor, getURLRequestHeaderInterface());
...
{
    boost::intrusive_ptr<as_object> obj = new URLRequestHeader_as3;
