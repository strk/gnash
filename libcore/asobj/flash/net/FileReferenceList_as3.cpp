// FileReferenceList_as3.cpp:  ActionScript "FileReferenceList" class, for Gnash.
//
...
#include "net/FileReferenceList_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<FileReferenceList_as3> ptr =
        ensureType<FileReferenceList_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new FileReferenceList_as3;
