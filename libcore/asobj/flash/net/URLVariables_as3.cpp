// URLVariables_as3.cpp:  ActionScript "URLVariables" class, for Gnash.
//
...
#include "net/URLVariables_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<URLVariables_as3> ptr =
        ensureType<URLVariables_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new URLVariables_as3;
