// URLRequestMethod_as3.h:  ActionScript 3 "URLRequestMethod" class, for Gnash.
//
...
class URLRequestMethod_as3: public as_object
{

public:

    URLRequestMethod_as3()
        :
        as_object(getURLRequestMethodInterface())
    {}
...
// GNASH_ASOBJ3_URLREQUESTMETHOD_H
#endif
