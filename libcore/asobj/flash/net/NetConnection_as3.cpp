// NetConnection_as3.cpp:  ActionScript "NetConnection" class, for Gnash.
//
...
#include "net/NetConnection_as3.h"
#include "log.h"
#include "fn_call.h"
...
{
    boost::intrusive_ptr<NetConnection_as3> ptr =
        ensureType<NetConnection_as3>(fn.this_ptr);
    UNUSED(ptr);
...
{
    boost::intrusive_ptr<as_object> obj = new NetConnection_as3;
