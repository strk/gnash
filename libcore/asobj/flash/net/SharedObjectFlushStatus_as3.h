// SharedObjectFlushStatus_as3.h:  ActionScript 3 "SharedObjectFlushStatus" class, for Gnash.
//
...
class SharedObjectFlushStatus_as3: public as_object
{

public:

    SharedObjectFlushStatus_as3()
        :
        as_object(getSharedObjectFlushStatusInterface())
    {}
...
// GNASH_ASOBJ3_SHAREDOBJECTFLUSHSTATUS_H
#endif
