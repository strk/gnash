// URLLoaderDataFormat_as3.h:  ActionScript 3 "URLLoaderDataFormat" class, for Gnash.
//
...
class URLLoaderDataFormat_as3: public as_object
{

public:

    URLLoaderDataFormat_as3()
        :
        as_object(getURLLoaderDataFormatInterface())
    {}
...
// GNASH_ASOBJ3_URLLOADERDATAFORMAT_H
#endif
