...
namespace {
    ...
    inline boost::uint8_t flag_preprocess(boost::uint8_t flgs,
            bool* douniq, bool* doindex);
    inline bool int_lt_or_eq (int a) { return a <= 0; }
    inline bool int_gt (int a) { return a > 0; }
...
array_class_init(as_object& glob, const ObjectURI& uri)
{
    ...
    as_object* ar = gl->createClass(&array_new, proto);
