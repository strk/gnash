...
void	jpeg_tables_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// \brief
/// A JPEG image without included tables; those should be in an
/// existing jpeg::input object stored in the movie. (SWF::DEFINEBITS)
void	define_bits_jpeg_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Handler for SWF::DEFINEBITSJPEG2 tag
void	define_bits_jpeg2_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// \brief
/// Loads a define_bits_jpeg3 tag. This is a jpeg file with an alpha
/// channel using zlib compression. (SWF::DEFINEBITSJPEG3)
void	define_bits_jpeg3_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	define_shape_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	define_shape_morph_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// SWF Tags DefineFont (10), DefineFont2 (48) and DefineFont3 (75)
//
/// Load a font and adds it the the movie definition.
///
void	define_font_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// SWF Tags Reflex (777)
//
void	reflex_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);
...
///
void	define_font_info_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// SWF Tag DefineFontName (88)
//  Load the display name and copyright string of a font.
//  This adds to an existing font.
void define_font_name_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Read SWF::DEFINETEXT and SWF::DEFINETEXT2 tags.
void	define_text_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Read an SWF::DEFINEEDITTEXT tag.
void	define_edit_text_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	place_object_2_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	define_bits_lossless_2_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);
...
void	remove_object_2_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	do_action_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	button_character_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Label the current frame  (SWF::FRAMELABEL)
void	frame_label_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);
...
void	define_sound_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	button_sound_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	do_init_action_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Load SWF::SOUNDSTREAMHEAD or SWF::SOUNDSTREAMHEAD2 tag.
void	sound_stream_head_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

/// Load a SWF::SOUNDSTREAMBLOCK tag.
void	sound_stream_block_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void	abc_loader(SWFStream&, tag_type, movie_definition&, const RunInfo&);

void
define_video_loader(SWFStream& in, tag_type tag, movie_definition& m, const RunInfo& r);

void
video_loader(SWFStream& in, tag_type tag, movie_definition& m, const RunInfo& r);

void
file_attributes_loader(SWFStream& in, tag_type tag, movie_definition& m, const RunInfo& r);

void
metadata_loader(SWFStream& in, tag_type tag, movie_definition& m, const RunInfo& r);
