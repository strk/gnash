// IDynamicPropertyOutput_as.hx:  ActionScript 3 "IDynamicPropertyOutput" class, for Gnash.
//
...
// is primarily useful only to test completeness of the API implementation.
        ...
        DejaGnu.done();
#else
	DejaGnu.note("This class (IDynamicPropertyOutput) is only available in flash9");
#end
    }
}
