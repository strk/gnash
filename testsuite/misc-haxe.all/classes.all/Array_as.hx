...
// versions prior to 6, these will be commented out until a later date
	...
	*/
    ...
    if (trysortarray.toString() == "But,alphabet,Different,capitalization") {
        ...
        DejaGnu.fail(" custom sort did not return"+
...
//check_equals(c[2.2], 2);
    ...
    if ( Std.is(spliced, Array) && spliced.toString() == "" 
        ...
        DejaGnu.fail("splice(0,-1), (negative length)"+
    ...
    if ( Std.is(spliced, Array) && spliced.toString() == "" 
        ...
        DejaGnu.fail("splice(3,-1), (negative length)"+
                     " did not return empty array; spliced = " + spliced);
    }
#end
    //check_equals ( ary.toString(), "2,3,4,5,6" );
    ...
    if ( Std.is(spliced, Array) && spliced.toString() == "" 
        ...
        DejaGnu.fail("splice(-1,-1), (negative length)"+
                     " did not return empty array; spliced = " + spliced);
    }
#end
    //check_equals ( ary.toString(), "2,3,4,5,6" );
    ...
    if (ary.toString() == "2,3,4,5,a,b,c,6") {
        ...
        DejaGnu.fail("ary changed. Invalid call to"+
    ...
    if (count == 8) {
        ...
        DejaGnu.fail(" splice does not fill holes in"+
    ...
    if (r.toString() == "8,5,3,1,0,-2,-7,-9") {
        ...
        DejaGnu.fail(" custom sort 'zero' does not"+
    ...
    if (b.toString() == "8,5,3,1,0,-2,-7,-9") {
        ...
        DejaGnu.fail(" custom sort 'zero' did not sort"+
    ...
    if (b.toString() == "8,5,3,1,0,-2,-7,-9") {
        ...
        DejaGnu.fail(" custom sort 'numeric' did not"+
    ...
    if (b.toString() == "8,5,3,1,0,-2,-7,-9") {
        ...
        DejaGnu.fail(" custom sort 'numericRev' did"+
    ...
    if (r.toString() == "0" ) {
        ...
        DejaGnu.fail(" UNI sort on c did not return correctly");
    }
    ...
    if (c.toString() ==  "Infinity,8.35,7.2,2,0.001,0,-0.5,-3.7,Infinity") {
        ...
        DejaGnu.fail(" UNI sort on c did not correctly sort c");
    }
    ...
    if (r.toString() == "0") {
        ...
        DejaGnu.fail(" UNI|NUM sort on c did not return correctly");
    }
    ...
    if (r.toString() == "0") {
        ...
        DejaGnu.fail(" UNI|NUM|DES sort on c did not return corrrectly");
    }
    ...
    if (r.toString() == "0") {
        ...
        DejaGnu.fail(" UNI|RIA sort on c did not return correctly");
    }
    ...
    if (r.toString() == "0") {
        ...
        DejaGnu.fail(" UNI|NUM|DES|RIA sort on c did not return correctly");
    }
    ...
    //check_equals( tolen(r), "[0, 2, 2, 2, 4, 5, 5]" );
		if (tolen(r) == "[0, 2, 2, 2, 4, 5, 5]") {
			...
			DejaGnu.fail(" cmp_fn, UNI|CAS sort on a did not return correctly");
		}
	} else {
		DejaGnu.fail(" sort returned 0");
	}
    //check_equals( tolen(a), "[0, 2, 2, 2, 4, 5, 5]" );
    if (tolen(a) == "[0, 2, 2, 2, 4, 5, 5]") {
        DejaGnu.pass("cmp_fn, UNI|CAS sort on a correctly sorted a");
    } else {
        DejaGnu.fail(" cmp_fn, UNI|CAS sort on a did not correctly sort a");
    }
    ...
    if (r.toString() == "0,1,2,3,4,5,6") {
        ...
        DejaGnu.fail(" cmp_fn, UNI|CAS|RIA sort on a did not return correctly");
    }
    ...
    if (r.toString() == "6,5,4,3,2,1,0") {
        ...
        DejaGnu.fail(" cmp_fn, UNI|CAS|RIA|DES sort on a did not return correctly");
    }
	...
	if (r.toString() == "-0.5,-3.7,0,0.001,2,7.2,8.35,Infinity,Infinity,null") {
		...
		DejaGnu.fail(" sort() on c with null value did not return correclty");
	}
	...
	if (c.toString() == "-0.5,-3.7,0,0.001,2,7.2,8.35,Infinity,Infinity,null") {
		...
		DejaGnu.fail(" sort() on c with null value did not sort c correctly");
	}
	...
	if (c.toString() == "-3.7,-0.5,0,0.001,2,7.2,8.35,Infinity,Infinity,null") {
		...
		DejaGnu.fail(" NUM sort on c with null did not sort c correctly");
	}
	...
	if (c.toString() == "null,Infinity,Infinity,8.35,7.2,2,0.001,0,-0.5,-3.7") {
		...
		DejaGnu.fail(" NUM|DES sort on c with a null did not sort c correctly");
	}
    //r = c.sort( Array.RETURNINDEXEDARRAY | Array.NUMERIC );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	                       [untyped Array.RETURNINDEXEDARRAY |
	...
	if (r.toString() == "9,8,7,6,5,4,3,1,2,0") {
		...
		DejaGnu.fail(" RIA|NUM sort on c with null did not return correctly");
	}
	#end
    //r = c.sort( Array.RETURNINDEXEDARRAY | Array.DESCENDING | Array.CASEINSENSITIVE );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	...
	if (r.toString() == "0,1,2,3,4,5,6,7,9,8") {
		...
		DejaGnu.fail(" RIA|DES|CAS sort on c did not return correctly");
	}
    //r = c.sort( Array.UNIQUESORT );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	                       [untyped Array.UNIQUESORT]);
	...
	if (r.toString() == "0") {
		...
		DejaGnu.fail(" UNI|RIA sort on c did not retur correctly: \n\t" + r.toString());
	}
	#if !flash9
    //r = c.sort( Array.UNIQUESORT | Array.NUMERIC | Array.DESCENDING | Array.RETURNINDEXEDARRAY );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	...
	if (r.toString() == "0") {
		...
		DejaGnu.fail(" all ARGS sort on c did not return correctly");
	}
	#end
	...
	if (c.toString() == "-3.7,-0.5,0,0.001,2,7.2,8.35,Infinity,null,null") {
		...
		DejaGnu.fail(" NUM sort on c did not correctly sort c");
	}
    //c.sort( Array.DESCENDING | Array.NUMERIC );
	Reflect.callMethod( c, Reflect.field(c, "sort"), 
	                   [untyped Array.DESCENDING | untyped Array.NUMERIC]);
	...
	if (c.toString() == "null,null,Infinity,8.35,7.2,2,0.001,0,-0.5,-3.7") {
		...
		DejaGnu.fail(" DES|NUM sort on c did not correctly sort c");
	}
    //r = c.sort( Array.RETURNINDEXEDARRAY | Array.NUMERIC );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	                       [untyped Array.RETURNINDEXEDARRAY |
	...
	if (r.toString() == "9,8,7,6,5,4,3,2,0,1") {
		...
		DejaGnu.fail(" RIA|NUM sort on c did not return correctly");
	}
    //check_equals( c.toString(), "null,null,Infinity,8.35,7.2,2,0.001,0,-0.5,-3.7" );
	if (c.toString() == "null,null,Infinity,8.35,7.2,2,0.001,0,-0.5,-3.7") {
		DejaGnu.pass("RIA|NUM sort on c correctly sorted c");
	} else {
		DejaGnu.fail(" RIA|NUM sort on c did not correctly sort c");
	}
    //r = c.sort( Array.UNIQUESORT );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	                       [untyped Array.UNIQUESORT]);
	...
	if (r.toString() == "0") {
		...
		DejaGnu.fail(" UNI sort on c with 'NaN' did not return correctly \n"
		             + r.toString());
	}
    //r = c.sort( Array.UNIQUESORT | Array.NUMERIC );
	r = Reflect.callMethod( c, Reflect.field(c, "sort"), 
	...
	if (tostr(r) == "Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" sortOn('Name') on a did not return correctly");
	}
	...
	if (tostr(a) == "Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" sortOn('Name') on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" sortOn('Year') on a did not return correctly");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" sortOn('Year') on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" sortOn('Electronic') on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" sortOn('Year', NUM) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "ENIAC,1944,true | Colossus,1943,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" sortOn('Year', NUM|DES) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" ('Year', UNI|NUM) on a did not return correctly");
	}
	//check_equals ( tostr(a), "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		DejaGnu.pass("sortOn('Year', UNI|NUM) on a correctly sorted a");
	} else {
		DejaGnu.fail(" sortOn('Year', UNI|NUM) on a did not correctly sort a");
	}
	...
	if (r.toString() == "0,1,2") {
		...
		DejaGnu.fail(" ('Year', RIA|NUM) on a did not return correclty");
	}
	//check_equals ( tostr(a), "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		DejaGnu.pass("('Year', RIA|NUM) on a correctly sorted a");
	} else {
		DejaGnu.fail(" ('Year', RIA|NUM) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" ('Name', UNI) on a did not return correctly");
	}
	//check_equals( tostr(a), "Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false" );
	if (tostr(a) == "Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		DejaGnu.pass("('Name', UNI) on a correctly sorted a");
	} else {
		DejaGnu.fail(" ('Name', UNI) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | ENIAC,1944,true | Colossus,1943,true") {
		...
		DejaGnu.fail(" ('Name', UNI|DES) on a did not return correctly");
	}
	...
	if (r.toString() == "2,1,0") {
		...
		DejaGnu.fail(" ('Name', UNI|RIA) on a does not return correctly");
	}
	...
	if (r.toString() == "0") {
		...
		DejaGnu.fail(" ('Electronic', UNI|RIA) on a does not return correctly");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | ENIAC,1944,true | Colossus,1943,true") {
		...
		DejaGnu.fail(" ('Electronic', UNI|DES) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year']) on a did not return correctly");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year']) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Electronic','Year']) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Electronic','Year'],[DES,NUM]) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year'],[DES,NUM]) on a did not return correctly");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Electronic','Year'],[DES,NUM]) on a did not return correctly");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" ('Megaflops') on a did not return correctly");
	}
	//check_equals( tostr(a), "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		DejaGnu.pass("('Megaflops') on a correctly sorted a");
	} else {
		DejaGnu.fail(" ('Megaflops') on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Binary','Turing complete']) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Inventor','Cost'],[DES,0]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | ENIAC,1944,true | Colossus,1943,true | Atanasoff-Berry,1941,true") {
		...
		DejaGnu.fail(" (['Name','Year','Cost'],[DES,NUM,0]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Cost','Year'],[0,0,NUM]) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Electronic','Year','Cost'],[UNI,NUM,NUM]) on a did not return correctly");
	}
	//check_equals( tostr(a), "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		DejaGnu.pass("(['Electronic','Year','Cost'],[UNI,NUM,NUM]) on a correctly sorted a");
	} else {
		DejaGnu.fail(" (['Electronic','Year','Cost'],[UNI,NUM,NUM]) on a did not correctly sort a");
	}
	...
	if (r.toString() == "0") {
		...
		DejaGnu.fail(" (['Electronic','Cost'],[UNI,NUM]) on a did not return correctly");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year'],[0]) on a did not return correctly");
	}
	//check_equals( tostr(a), "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false" );
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		DejaGnu.pass("(['Name','Year'],[0]) on a correctly sorted a");
	} else {
		DejaGnu.fail(" (['Name','Year'],[0]) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year'],[DES]) on a did not return correctly");
	}
	//check_equals( tostr(a), "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false" );
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		DejaGnu.pass("(['Name','Year'],[DES]) on a correctly sorted a");
	} else {
		DejaGnu.fail(" (['Name','Year'],[DES]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Electronic'],[DES]) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year'],[RIA]) on a did not return correctly");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Name','Year'],NUM) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "ENIAC,1944,true | Colossus,1943,true | Atanasoff-Berry,1941,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Electronic','Year','Name'],NUM|DES) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Electronic'],[DES]) on a did not return correctly");
	}
	//check_equals( tostr(a), "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false" );
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		DejaGnu.pass("(['Name','Electronic'],[DES]) on a correctly sorted a");
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Name','Year'],[RIA]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (id) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (id, CAS|DES) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" ([id], 0) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" ([yr,id],[NUM,DES]) on a did not correctly sort a");
	}
	...
	if (tostr(r) == "Name,Year,Year | Year,Name,Year") {
		...
		DejaGnu.fail(" (['Name']) on b did not return correctly");
	}
	...
	if (tostr(b) == "Name,Year,Year | Year,Name,Year") {
		...
		DejaGnu.fail(" (['Name']) on b did not correctly sort b");
	}
	//b.sortOn( "Year" );
	...
	if (tostr(b) == "Year,Name,Year | Name,Year,Year") {
		...
		DejaGnu.fail(" (['Year']) on b did not correctly sort b");
	}
	...
	if (tostr(b) == "Name,Year,Year | Year,Name,Year") {
		...
		DejaGnu.fail(" ([['Year','Name'],[NUM|DES,0]]) on b did not correctly sort b");
	}
	...
	if (r == null) {
		...
		DejaGnu.fail(" sortOn() did not return correctly");
	}
	//check_equals( tostr(a), "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		DejaGnu.pass("sortOn() on a correctly sorted a");
	} else {
		DejaGnu.fail(" sortOn() on a did not correctly sort a");
	}
	#end
	...
	if (Reflect.isObject(r)) {
		...
		DejaGnu.fail(" sortOn(undefined) on a did not return an object");
	}
	...
	if (untyped __instanceof__(r, Array)) {
		...
		DejaGnu.fail(" sortOn(undefined) on a did not return an Array");
	}
	#else
	if (Std.is(r, "Array")) {
		DejaGnu.pass("sortOn(undefined) on a returned an Array");
	} else {
		DejaGnu.fail(" sortOn(undefined) on a returned an Array");
	}
	#end
	//check_equals( tostr(a), "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true" );
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" sortOn(undefined) on a changed a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Year','Electronic','Name'],numeric) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" ('name') on a did not correctly sort a");
	}
	//a.sortOn( ["year", "name"], Array.NUMERIC );
	Reflect.callMethod(a, Reflect.field(a, "sortOn"), [["year","name"], 
	                   untyped Array.NUMERIC]);
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['year','name'],NUM) on a did not correctly sort a");
	}
	#else
	...
	if (tostr(a) == "Harvard Mark I,1944,undefined | ENIAC,1944,true | Colossus,1943,true | Atanasoff-Berry,1941,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Electronic','Year'],DES|IGN) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | ENIAC,1944,true | Colossus,1943,true | Atanasoff-Berry,1941,true | Harvard Mark I,1944,undefined") {
		...
		DejaGnu.fail(" (['Electronic','Year'],[NUM,DES]) on a did not correctly sort a");
	}
	...
	//check_equals( tostr(r), "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Harvard Mark I,1944,undefined" );
		if (tostr(r) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Harvard Mark I,1944,undefined") {
			...
			DejaGnu.fail(" (['Electronic','Name'],[UNI,NUM]) on a did not return correctly");
		}
	} else {
	...
	if (tostr(a) == "Zuse Z3,1941,false | Atanasoff-Berry,1941,true | Colossus,1943,true | ENIAC,1944,true | Harvard Mark I,1944,undefined") {
		...
		DejaGnu.fail(" (['Electronic','Name'],[UNI,NUM]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Harvard Mark I,1944,undefined | Colossus,1943,true | ENIAC,1944,true | Zuse Z3,1941,false") {
		...
		DejaGnu.fail(" (['Mass','Name'],[0,0]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Harvard Mark I,1944,undefined | Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true") {
		...
		DejaGnu.fail(" (['Mass','Year','Name'],[NUM|DES,NUM|DES|0]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Atanasoff-Berry,1941,true | Harvard Mark I,1944,undefined | Zuse Z3,1941,false | ENIAC,1944,true | Colossus,1943,true") {
		...
		DejaGnu.fail(" (['Mass','Name'],[UNI,DES]) on a did not correctly sort a");
	}
	...
	if (tostr(a) == "Zuse Z3,1941,false | Colossus,1943,true | ENIAC,1944,true | Atanasoff-Berry,1941,true | Harvard Mark I,1944,undefined") {
		...
		DejaGnu.fail(" (['Electronic','Mass','Name'],[0,NUM|DES,0]) on a did not correctly sort a");
	}
	...
	if (r.toString() == "0,3,1,2,4") {
		...
		DejaGnu.fail(" (['Electronic','Mass','Year','Name'],[RIA,NUM,NUM,DES]) on a did not correctly sort a");
	}
	#end
	}//end sortOn_Test
	...
	for(i in 0...b.length) {
		if (Std.is(b[i],String)) {
			...
			DejaGnu.fail(" i is not a String");
		}
		untyped out[i] = 1;
		untyped out['len']++;
	}
	...
	if (untyped out['len'] == 2) {
		...
		DejaGnu.unresolved(" out['len'] != 2");
	}
	//check_equals(out[0], 1);
	if (untyped out[0] == 1) {
		DejaGnu.pass("out[0] == 1");
	} else {
		DejaGnu.unresolved(" out[0] != 1");
	}
	//check_equals(out[1], 1);
	if (untyped out[1] == 1) {
		DejaGnu.pass("out[1] == 1");
	} else {
		DejaGnu.unresolved(" out[1] != 1");
	}
	...
	*/
	...
	if (a.length == 0) {
		...
		DejaGnu.fail(" new array a does not have length 0");
	}
	//a[-1] = 'minusone';
	a[-1] = 'minusone';
	//check_equals(a.length, 0);
	if (a.length == 0) {
		...
		DejaGnu.fail(" assigning a[-1] changed a.length");
	}
	//check_equals(a[-1], 'minusone');
	if (a[-1] == 'minusone') {
		DejaGnu.pass("a[-1] == 'minusone' still");
	} else {
		DejaGnu.fail(" a[-1] != 'minusone'");
	}
	//a["Infinite"] = 'inf';
	...
	if (ret == true) {
		...
		DejaGnu.fail(" a.addProperty returned false");
	}
	//junk = a[1];
	var junk = a[1];
	...
	if (getCalls == 1) {
		...
		DejaGnu.fail(" getCalls not increased by 1");
	}
	//check_equals(setCalls, 0);
	if (setCalls == 0) {
		DejaGnu.pass("setCalls == 0");
	} else {
		DejaGnu.fail(" setCalls != 0");
	}
	...
	if (getCalls == 0) {
		...
		DejaGnu.fail(" getCalls != 0");
	}
	//xcheck_equals(setCalls, 1);
	if (setCalls == 1) {
		DejaGnu.xpass("setCalls increased by 1");
	} else {
		DejaGnu.xfail(" setCalls not increased by 1");
	}
	...
	if (ret == true) {
		...
		DejaGnu.fail(" a.addProperty('2') did not return true");
	}
	...
	if (getCalls == 1) {
		DejaGnu.xpass(" getCalls increased by 1");
	} else {
		DejaGnu.xfail(" getCalls not increased by 1");
	}
	//check_equals(setCalls, 0);
	if (setCalls == 0) {
		DejaGnu.pass("setCalls == 0");
	...
	if (getCalls == 0) {
		...
		DejaGnu.fail(" a.push made a call to get");
	}
	//check_equals(setCalls, 0);
	if (setCalls == 0) {
		DejaGnu.pass("a.push did not call set");
	} else {
		DejaGnu.fail(" a.push made a call to set");
	}
	...
	static public function popProtected_Test() {
        ...
        if ( !(untyped a.hasOwnProperty(1))) {
            ...
            DejaGnu.fail(" a still has property '1'");
        }
        ...
        if (untyped a.hasOwnProperty(0)) {
            ...
            DejaGnu.fail(" a no longer has the property '0'");
        }
        //~ xcheck(a.hasOwnProperty(1)); 
        if (untyped a.hasOwnProperty(1)) {
            DejaGnu.xpass("a still has the property '1'");
        } else {
            DejaGnu.xfail(" a no longer has the property '1'");
        }
#end
	...
	static public function popReadOnly_Test() {
        ...
        if (a[0] == 'overridden') {
            ...
            DejaGnu.fail(" a[0] != 'overridden'");
        }
        //check(!a.hasOwnProperty(1)); 
        if ( !(untyped a.hasOwnProperty(1))) {
            DejaGnu.pass("a no longer has the property '1'");
        } else {
            DejaGnu.fail(" a still has the property '1'");
        }
        ...
        if (a[1] == 'one') {
            DejaGnu.xpass(" a[1] == 'one'");
        } else {
            DejaGnu.xfail(" a[1] != 'one'");
        }
        //check_equals(a.length, 3);
        if (a.length == 3) {
            DejaGnu.pass("a.length == 3");
