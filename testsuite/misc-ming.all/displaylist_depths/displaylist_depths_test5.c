 ...
 * 
 *  Before the jump we have a single instance at depth -16381 and position 50,200.
 *  After the jump we have the same instances at depth -16381, repositioned at 10,200.
...
#define OUTPUT_FILENAME "displaylist_depths_test5.swf"
...
main(int argc, char** argv)
{
	...
	add_actions(mo,
		...
		// this reset char at depth -16381 to be at position 10,200
		"gotoAndStop(2);"
		...
		// by PlaceObject2 tag in frame 2.
		// Note that the PlaceObject2 in frame 2 has the "move" flag
		// set to off as it's really intended to be used to *create*
		// an instance. Instead, since that depth is already occupied,
		// it behave as if it was a transforming PlaceObject2
		"check_equals(static3._x, 10);" 
