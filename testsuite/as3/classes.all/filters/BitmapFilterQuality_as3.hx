// BitmapFilterQuality_as3.hx:  ActionScript 3 "BitmapFilterQuality" class, for Gnash.
//
...
class BitmapFilterQuality_as3 {
    static function main() {
        var x1:BitmapFilterQuality = new BitmapFilterQuality();

        // Make sure we actually get a valid class        
        if (x1 != null) {
            DejaGnu.pass("BitmapFilterQuality class exists");
        } else {
