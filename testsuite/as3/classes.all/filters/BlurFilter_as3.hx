// BlurFilter_as3.hx:  ActionScript 3 "BlurFilter" class, for Gnash.
//
...
class BlurFilter_as3 {
    static function main() {
        var x1:BlurFilter = new BlurFilter();

        // Make sure we actually get a valid class        
        if (x1 != null) {
            DejaGnu.pass("BlurFilter class exists");
        } else {
            DejaGnu.fail("BlurFilter class doesn't exist");
        }
